...
vocab_size = 32
teacher_forcing_ratio = 0.5 #0~1
empty_input_ratio = 0.1
KLD_weight = 0.0 #0~1 step 0.001
LR = 0.05
MAX_LENGTH = 10
...
def prepareData(mode='train'):
    print("Reading {}.txt".format(mode))
    if mode = 'train':
        file = './train.txt'
    else:
        file = './test.txt'
...
train_pair = prepareData(mode = 'train')
test_pair = prepareData(mode = 'test')
